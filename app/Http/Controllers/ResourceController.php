    ...
    public function index($table, Request $request)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Auth::user()->hasPermission('browse bread ' . $table)){
                    abort('401');
                }
            }
        }
    ...
    public function create($table, Request $request)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Auth::user()->hasPermission('add bread ' . $table)){
                    abort('401');
                }
            }
        }        
    ...
    public function show($table, $id, Request $request)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Auth::user()->hasPermission('read bread ' . $table)){
                    abort('401');
                }
            }
        } 
    ...
    public function edit($table, $id)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Auth::user()->hasPermission('edit bread ' . $table)){
                    abort('401');
                }
            }
        }
    ...
    public function destroy($table, Request $request, $id)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Auth::user()->hasPermission('delete bread ' . $table)){
                    abort('401');
                }
            }
        }
