...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function insertLink($roles, $name, $href, $icon = null){
        ...
        if(empty($permission)){
            $permission = Permission::create(['name' => $name, 'slug' => $name]);
        }
        $roles = explode(',', $roles);
        if(in_array('user', $roles)){
            $this->userRole->attachPermission($permission);
        }
    ...
    { 
        ...
        $this->insertLink('super.admin,guest,user,admin', 'Dashboard', '/', 'cil-speedometer');
        $this->beginDropdown('super.admin,admin', 'Settings', 'cil-calculator');
            ...
            $this->beginDropdown('super.admin', 'Roles And Permissions', 'cil-child');
                $this->insertLink('super.admin', 'Edit Permissions', '/permissions');
                $this->insertLink('super.admin', 'Edit Roles', '/roles');
            $this->endDropdown();
            $this->insertLink('super.admin', 'Media', '/media');
            $this->insertLink('super.admin', 'BREAD', '/bread');
            $this->insertLink('super.admin', 'Email', '/mail');
        $this->endDropdown();
        $this->insertLink('guest', 'Login', '/login', 'cil-account-logout');
        $this->insertLink('guest', 'Register', '/register', 'cil-account-logout');
        $this->beginDropdown('super.admin', 'Theme Components', 'cil-puzzle');
