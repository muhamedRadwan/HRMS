...
return [
    ...
    */
    ...
    'titles' => [
        'dashboard'                 => "لوحة معلومات الوظائف" ,
        'show-role'                 => "إظهار الوظيفة: <strong>:name </strong>" ,
        'show-permission'           => "إظهار الإذن: <strong>:name </strong>" ,
        'roles-table'               => "الوظائف النشطة" ,
        'roles-card'                => "الوظائف" ,
        'role-card'                 => 'وظيفة: ',
        'permissions-card'          => "أذونات" ,
        'permissions-table'         => "أذونات نشطة" ,
        'dropdown-menu-alt'         => "إظهار القائمة المنسدلة للوظائف" ,
        'create-role'               => "إنشاء وظيفة جديد" ,
        'edit-role'                 => "وظيفة التحرير: <strong>:name </strong>" ,
        'create-permission'         => "إنشاء إذن جديد" ,
        'edit-permission'           => "إذن التحرير: <strong>:name </strong>" ,
        'roles-deleted-table'       => "الوظائف المحذوفة" ,
        'show-role-deleted'         => "إظهار الوظيفة المحذوف: <strong>:name </strong>" ,
        'permissions-deleted-table' => "أذونات محذوفة" ,
        'show-permission-deleted'   => "إظهار الإذن المحذوف: <strong>:name </strong>",
    ],

    'cards' => [
        'users-count'       => '{1} :عدد المستخدمين|[2,*] :عدد المستخدمين',
        'permissions-count' => '{1} :عدد الاذونات|[2,*] :عدد الاذونات',
        'roles-count'       => '{1} :عدد الوظائف|[2,*] :عدد الوظائف',
        'none-count'        => 'لا يوجد',
        'level'             => 'المستوي :level',
        'role-card'         => [
            ...
            'permissions-id'            => "معرف الإذن" ,
            'permissions-name'          => "اسم الإذن" ,
            'table-users-caption'       => "المستخدمون الذين لهم وظيفة: <strong><em>:role</em></strong>" ,
            'table-permissions-caption' => "أذونات لها وظيفة: <strong><em>:role</em></strong>" ,
        ],
        'permissions-card' => [
            'role-id'                           => "معرف الوظيفة" ,
            'role-name'                         => 'اسم الوظيفة',
            'permissions-table-roles-caption'   => "الوظائف التي لها إذن: <strong><em>:permission</em> </strong>" ,
            'permissions-table-users-caption'   => "المستخدمون الذين لديهم إذن: <strong><em>:permission</em> </strong>" ,
        ],
        'role-info-card' => [
            'role-id'           => "معرف الوظيفة" ,
            'role-name'         => 'اسم الوظيفة',
            'role-desc'         => 'وصف الوظيفة',
            'role-level'        => "مستوى الوظيفة" ,
            'role-users'        => "وظيفة المستخدمين" ,
            'role-permissions'  => "أذونات الوظيفة" ,
            'created'           => 'أنشئت في',
        ...
        'permission-info-card' => [
            'permission-id'     => "معرف الإذن" ,
            'permission-name'   => "اسم الإذن" ,
            'permission-slug'   => "سبيكة الإذن" ,
            'permission-model'  => "نموذج الإذن" ,
            'permission-roles'  => "وظائف الإذن" ,
            'permission-users'  => "مستخدمو الأذونات" ,
            'created'           => 'أنشئت في',
            'updated'           => 'تم التحديث في',
            'deleted'           => "تم الحذف في" ,
            'none'              => "لا شيء" ,
            'permission-desc'   => "وصف الإذن" ,
        ],
    ...
    'roles-table' => [
        ...
        'deletedAt'     => 'تم الحذف',
        'actions'       => 'أجراءات',
        'none'          => "لا يوجد عناصر وظيفة" ,
        'caption'       => '{1}: حساب إجمالي الوظائف | [2، *]: حساب إجمالي الوظائف',
