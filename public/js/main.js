...
const mainChart = new Chart(document.getElementById('main-chart'), {
  ...
  data: {
    ...
    datasets: [
      ...
      {
        label: 'طلبات الاستئذان المقبوله',
        backgroundColor: 'transparent',
      ...
      {
        label: ' طلبات الاستئذان غير المقبوله',
        backgroundColor: 'transparent',
...
$.get("https://hrms.test/mainchart", function(data){
  ...
  data.Attendance.forEach(month => {
    mainChart.data.labels.push(month.name);
    mainChart.data.datasets[0].data.push(month.data); 
  });
  data.LeaveRequestApproved.forEach(month => {
    mainChart.data.datasets[1].data.push(month.data); 
  });
  data.LeaveRequestNotApproved.forEach(month => {
    mainChart.data.datasets[2].data.push(month.data); 
  });
  mainChart.update();
});